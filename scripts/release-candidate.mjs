...
export function validateNativeReceipt(report, platform, producer, producerSha256) {
...
export function readReleaseCandidate(directory, expectedCommit, expectedPackages) {
