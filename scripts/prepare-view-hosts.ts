...
assert(rn && lynx, 'Usage: node scripts/prepare-view-hosts.ts RN_BASELINE_HOST LYNX_BASELINE_HOST');
const report = JSON.parse(readFileSync(path.join(root, 'target/view-events/export-report.json'), 'utf8'));
