...
| [009](009-async-lifecycle-protocol.md) | [#13 — [M3] Add nonblocking invocation with cancellation and teardown semantics](https://github.com/gronxb/tauri-native/issues/13) | P1 | L | 004, 007, 008 | IMPLEMENTED · native gates passed |
