...
| [018](018-retained-tauri-dispatch.md) | [#42 — [M7] Preserve Builder setup, State and AppHandle in generated integration](https://github.com/gronxb/tauri-native/issues/42) | P1 | L | 017 | IN PROGRESS · desktop and Android Lynx direct dispatch passed |
| [019](019-mobile-plugin-lifecycle.md) | [#43 — [M7] Preserve native mobile plugins, permissions and OS callbacks](https://github.com/gronxb/tauri-native/issues/43) | P1 | L | 017, 018 | IN PROGRESS · official-plugin fixture; mobile gates pending |
