...
Execution order: #41 establishes standalone real-runtime behavior and mobile renderer coexistence; #42 preserves actual startup/dispatch; #43 adds native plugin and permission lifecycle; #44 packages the runtime/dependencies; #45 and #46 integrate RN/Expo and Lynx; #47 gates parity in all six mobile combinations. #41 is IN PROGRESS: the real desktop/iOS/Android baseline and iOS/Android Lynx native UI/lifecycle gates passed on 2026-09-09. Both RN combinations remain open; see the evidence in #41. Desktop-only APIs keep upstream platform restrictions. Support for third-party plugins requires an explicit verified matrix.
