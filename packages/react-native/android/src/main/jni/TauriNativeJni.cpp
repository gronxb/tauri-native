...
Java_com_reactnativetauri_TauriNativeRust_createSession(JNIEnv* env, jobject) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_reactnativetauri_TauriNativeRust_startBytes(JNIEnv* env, jobject, jlong session, jbyteArray idValue, jbyteArray commandValue, jbyteArray payloadValue) {
  try {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_reactnativetauri_TauriNativeRust_pollBytes(JNIEnv* env, jobject, jlong session) {
  try {
    const auto& api = rustApi();
...
Java_com_reactnativetauri_TauriNativeRust_cancelBytes(JNIEnv* env, jobject, jlong session, jbyteArray idValue) {
  try {
...
extern "C" JNIEXPORT void JNICALL
Java_com_reactnativetauri_TauriNativeRust_closeSession(JNIEnv* env, jobject, jlong session) {
