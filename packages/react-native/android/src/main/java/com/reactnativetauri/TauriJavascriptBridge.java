      ...
      switch (type) {
        ...
        case "invoke":
          ...
          if (session == 0) {
            ...
            deliver(document, "__RNTauriResolve", id, TauriNativeRust.INSTANCE.invoke(command, payload));
          } else {
            String acknowledgement = TauriNativeRust.INSTANCE.start(session, id, command, payload);
