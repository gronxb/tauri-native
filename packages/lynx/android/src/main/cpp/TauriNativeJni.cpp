...
Java_dev_taurinative_lynx_TauriNativeRust_invokeBytes(
  JNIEnv* env,
  jobject,
...
Java_dev_taurinative_lynx_TauriNativeRust_createSession(JNIEnv* env, jobject) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_dev_taurinative_lynx_TauriNativeRust_startBytes(JNIEnv* env, jobject, jlong session, jbyteArray idValue, jbyteArray commandValue, jbyteArray payloadValue) {
  try {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_dev_taurinative_lynx_TauriNativeRust_pollBytes(JNIEnv* env, jobject, jlong session) {
  try {
    const auto& api = rustApi();
...
Java_dev_taurinative_lynx_TauriNativeRust_cancelBytes(JNIEnv* env, jobject, jlong session, jbyteArray idValue) {
  try {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_taurinative_lynx_TauriNativeRust_closeSession(JNIEnv* env, jobject, jlong session) {
